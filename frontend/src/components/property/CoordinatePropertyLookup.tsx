...
interface CoordinatePropertyLookupProps {
    onBackToDashboard?: () => void;
}

export const CoordinatePropertyLookup: React.FC<CoordinatePropertyLookupProps> = ({ onBackToDashboard }) => {
    // --- STATE AND HANDLERS ---
                ...
                <div className="card-glass animate-fade-in-down">
                    ...
                    <div className="space-y-6">
                        <div className="animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
                            <label className="block text-sm font-medium text-gray-300 mb-4">📍 Select Property Location</label>
                            <LocationPicker
                                onChange={(location) => {
                                    setCoordinates({
                        ...
                        <div className="max-w-xs animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                            <label className="block text-sm font-medium text-gray-300 mb-3">Search Radius (meters)</label>
                            <input
                                type="number"
            ...
            <div className="max-w-6xl mx-auto p-6 animate-fade-in">
                <div className="card-glass animate-fade-in-down">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <button onClick={onBackToDashboard || handleReset} className="btn-secondary flex items-center space-x-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                            </svg>
                            <span>{onBackToDashboard ? 'Back to Dashboard' : 'Back to Search'}</span>
                        </button>
                    </div>
                ...
                <div className="card-glass animate-fade-in-down">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <button onClick={onBackToDashboard || handleReset} className="btn-secondary flex items-center space-x-2">
                            ...
                            <span>{onBackToDashboard ? 'Back to Dashboard' : 'New Search'}</span>
                        </button>
                    </div>
                    ...
                    <div className="mt-6 text-xs text-gray-500">
                        Last updated:{" "}
                        {new Date(valuation.lastUpdated).toLocaleString("en-IN", {
